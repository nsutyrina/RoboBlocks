...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFFFF4D5D);
  late Color secondary = const Color(0xFF18E7EF);
  late Color tertiary = const Color(0xFFFEC923);
  late Color alternate = const Color(0xFF1CEBC1);
