...
class _DanceWidgetState extends State<DanceWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DanceModel());

    logFirebaseEvent('screen_view', parameters: {'screen_name': 'Dance'});
                      ...
                      Align(
                        ...
                        child: Padding(
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              logFirebaseEvent('DANCE_PAGE__BTN_ON_TAP');
                        ...
                        children: [
                          ...
                          Padding(
                            padding: EdgeInsetsDirectional.fromSTEB(
                                20.0, 20.0, 20.0, 0.0),
                            child: Text(
                              '- The \"dance\" block makes your robot do a fun dance!\n\n- It\'s a special move that makes the robot spin, jump, or wiggle!\n\n- Example: When you use the \"dance\" block, the character dances in place to celebrate!',
