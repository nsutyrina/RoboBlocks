...
import '/misc/net_promoter_score/net_promoter_score_widget.dart';
import '/index.dart';
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: InkWell(
                      ...
                      onTap: () async {
                        logFirebaseEvent('HOME_PAGE_PAGE_Rob_ON_TAP');
              ...
              if (FFAppState().isDeviceConnected)
                Padding(
                  ...
                  child: FFButtonWidget(
                    onPressed: () async {
                      logFirebaseEvent(
                          'HOME_PAGE_PAGE_REMOTE_CONTROL_BTN_ON_TAP');
                      logFirebaseEvent('Button_navigate_to');

                      context.pushNamed(RemoteControlWidget.routeName);
                    },
                    text: 'Remote Control',
                    options: FFButtonOptions(
                      width: 300.0,
              ...
              Expanded(
                child: GridView(
                  ...
                  children: [
                    Padding(
                      padding:
                          EdgeInsetsDirectional.fromSTEB(45.0, 50.0, 0.0, 0.0),
                      child: Container(
                        width: 100.0,
                        height: 100.0,
                        decoration: BoxDecoration(
                        ...
                        child: InkWell(
                          ...
                          onTap: () async {
                            logFirebaseEvent(
                                'HOME_PAGE_PAGE_Column_ouskqdl3_ON_TAP');
