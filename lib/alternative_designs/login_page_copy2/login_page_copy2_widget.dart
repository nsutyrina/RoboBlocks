...
import 'login_page_copy2_model.dart';
export 'login_page_copy2_model.dart';

class LoginPageCopy2Widget extends StatefulWidget {
  const LoginPageCopy2Widget({super.key});

  static String routeName = 'LoginPageCopy2';
  static String routePath = '/loginPageCopy2';

  @override
  State<LoginPageCopy2Widget> createState() => _LoginPageCopy2WidgetState();
}

class _LoginPageCopy2WidgetState extends State<LoginPageCopy2Widget> {
  late LoginPageCopy2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => LoginPageCopy2Model());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'LoginPageCopy2'});
            ...
            children: [
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: FFButtonWidget(
                        onPressed: () async {
                          logFirebaseEvent(
                              'LOGIN_PAGE_COPY2_PAGE_LoginButton_ON_TAP');
              ...
              Padding(
                ...
                child: InkWell(
                  ...
                  onTap: () async {
                    logFirebaseEvent(
                        'LOGIN_COPY2_SignInWithGoogleButton_ON_TA');
              ...
              Padding(
                ...
                child: FFButtonWidget(
                  onPressed: () async {
                    logFirebaseEvent(
                        'LOGIN_PAGE_COPY2_PAGE_SIGN_UP_BTN_ON_TAP');
