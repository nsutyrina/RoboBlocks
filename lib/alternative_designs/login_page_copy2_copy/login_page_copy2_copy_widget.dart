...
import 'login_page_copy2_copy_model.dart';
export 'login_page_copy2_copy_model.dart';

class LoginPageCopy2CopyWidget extends StatefulWidget {
  const LoginPageCopy2CopyWidget({super.key});

  static String routeName = 'LoginPageCopy2Copy';
  static String routePath = '/loginPageCopy2Copy';

  @override
  State<LoginPageCopy2CopyWidget> createState() =>
      _LoginPageCopy2CopyWidgetState();
}

class _LoginPageCopy2CopyWidgetState extends State<LoginPageCopy2CopyWidget> {
  late LoginPageCopy2CopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => LoginPageCopy2CopyModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'LoginPageCopy2Copy'});
        ...
        body: Container(
          ...
          decoration: BoxDecoration(
            ...
            image: DecorationImage(
              fit: BoxFit.cover,
              image: Image.asset(
                'assets/images/ChatGPT_Image_Apr_13,_2025_at_10_52_18_AM.png',
              ).image,
            ),
          ),
          child: Column(
            ...
            children: [
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: FFButtonWidget(
                        onPressed: () async {
                          logFirebaseEvent(
                              'LOGIN_COPY2_COPY_LoginButton_ON_TAP');
              ...
              Padding(
                ...
                child: InkWell(
                  ...
                  onTap: () async {
                    logFirebaseEvent(
                        'LOGIN_COPY2_COPY_SignInWithGoogleButton_');
              ...
              Padding(
                ...
                child: FFButtonWidget(
                  onPressed: () async {
                    logFirebaseEvent('LOGIN_COPY2_COPY_SIGN_UP_BTN_ON_TAP');
